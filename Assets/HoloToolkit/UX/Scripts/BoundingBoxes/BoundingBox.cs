    ...
    public class BoundingBox : MonoBehaviour
    {
        ...
        public static void GetMeshFilterBoundsPoints(GameObject target, List<Vector3> boundsPoints, LayerMask ignoreLayers)
        {
            ...
            for (int i = 0; i < meshFilters.Length; i++)
            {
                ...
                //NOTE: commonted by Zoltan Jin
                if(ignoreLayers == (1 << meshFilterObj.gameObject.layer | ignoreLayers)) {
                    continue;
                }

                // When the layer = 13(GenerateMesh), the object will contribute to the calculation
                // of bounding box;
                // When the layer = Default, the object will not contribute to the calculation
                // of bounding box;
                //LayerMask tmpLM = 13;
                //if(tmpLM == (1 << meshFilterObj.gameObject.layer | tmpLM)) {
                //    continue;
                //}
