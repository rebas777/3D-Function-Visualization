Shader /*ase_name*/ "QFX/SFX/Templates/Particles Alpha Blended Invert Fade" /*end*/
{
	Properties
	{
		...
		SubShader
		{
			...
			Pass {
				...
				fixed4 frag ( v2f i /*ase_frag_input*/ ) : SV_Target
				{
					...
					fixed4 col = /*ase_frag_out:Color;Float4*/2.0f * i.color * _TintColor * tex2D(_MainTex, i.texcoord.xy) * (1 - fade)/*end*/;
